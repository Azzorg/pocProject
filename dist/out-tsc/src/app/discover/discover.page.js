...
var DiscoverPage = /** @class */ (function () {
    function DiscoverPage(document /*, public platform : Platform*/) {
    }
    ...
    DiscoverPage.prototype.onWindowScroll = function (e) {
        ...
        if (document.getElementById("main_container").getBoundingClientRect().top < 5) {
            this.blurTitle = true;
            var element = document.getElementById('title_trip');
     ...
     */
    DiscoverPage.prototype.generateTrip = function () {
     ...
     * @param action
     */
    DiscoverPage.prototype.getAction = function (action) {
    ...
    ], DiscoverPage.prototype, "onWindowScroll", null);
